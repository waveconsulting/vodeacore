        ...
        <div id="right-sidebar" class="settings-panel">
            ...
            <ul class="chat-list">
                <li class="list active">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face1.jpg" alt="image">
                ...
                <li class="list">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face2.jpg" alt="image">
                ...
                <li class="list">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face3.jpg" alt="image">
                        <span class="online"></span>
                    </div>
                    <div class="info">
                        <p>Daniel Russell</p>
                ...
                <li class="list">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face4.jpg" alt="image">
                        <span class="offline"></span>
                    </div>
                    <div class="info">
                ...
                <li class="list">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face5.jpg" alt="image">
                        <span class="online"></span>
                    </div>
                    <div class="info">
                ...
                <li class="list">
                    <div class="profile">
                        <img src="{!! url('/') !!}/assets/vodeacore/images/faces/face6.jpg" alt="image">
                        <span class="online"></span>
                    </div>
                    <div class="info">
                        <p>Sarah Graves</p>
